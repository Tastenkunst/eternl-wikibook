...
Pools are first sorted by their pledge amount, but only if their margin is below 1%, the pledge is fulfilled, and exceeds 50 ADA. Pools not meeting these criteria are moved to the end of the list.
