...
Protecting your cryptocurrency assets begins with understanding how to properly handle and store your credentials. This guide combines essential security principles with specific tips for using Eternl Wallet.
...
Do not use Google Drive, iCloud, or Dropbox.

**Communication Apps:**
Avoid email drafts, note-taking apps, or messaging services.
...
Store your phrase on non-internet-connected media to remain immune to hacking and malware.

---

**Physical Writing:**

Write it on paper, but be aware that ink can fade or become unreadable over time.

---

**Metal Backups:**

For long-term security, use stainless steel plates or "cryptosteel." These are resistant to fire, water, and corrosion.

---

**Redundancy:**

Maintain multiple copies in different secure locations (e.g., a safe or locked drawer) so that a single incident like a fire or theft does not destroy your only access.
