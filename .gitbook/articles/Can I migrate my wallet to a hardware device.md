...
<strong> Here's a general overview of the process step be step </strong>

### 1. Download Eternl Extension

First, download the Eternl extension for your browser. Ensure to download it from an authentic source. All official Eternl.io links are available here.
Be aware that from time to time scamming websites imitating Eternl appear. Always check if the website you’re visiting is the correct one.
